...
import com.ttsh.ifhaam.models.Constraints.CreditSubjectBeforeDay;
 ...
 * @author Ahmed
 */
public class CreditBeforeDayPan extends javax.swing.JPanel implements ConstraintValueater{
    CreditSubjectBeforeDay con;
    /**
     * Creates new form CreditBeforeSubjectPan
     */
    public CreditBeforeDayPan() {
        initComponents();
       spnDate.setValue(1);
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(spnCredit, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
    ...
    public Constraint getConstraint() throws ConstraintException {
        ...
        int day = (int)spnDate.getValue();
        int credit = (int)spnCredit.getValue();
        
        con = new CreditSubjectBeforeDay(fitness,day,credit);
        return con;
    }
